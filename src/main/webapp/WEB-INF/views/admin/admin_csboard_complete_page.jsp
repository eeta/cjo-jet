			...
			<div class="row">	<%--탭 페이지  --%>
				<div class="col">
					<ul class="nav nav-tabs">
					  ...
					  <li class="nav-item">
					    <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath }/admin/admin_csboard_complete_page.do">
					    	답변 완료
					    </a>
					  </li>
					  <li class="nav-item">
			...
			<div class="row mt-2"> <%--문의글 테이블 --%>
				<div class="col">
					...
					<div class="row">	 <%--검색 row--%>
						<div class="col-8"></div>
						<div class="col">
						<form action="${pageContext.request.contextPath }/admin/admin_csboard_complete_page.do" method="get">
							<div class="row">
								<div class="col-3">
