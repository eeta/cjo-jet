				...
				<div class="col">
					<ul class="nav nav-tabs">
					  ...
					  <li class="nav-item">
					   ...
					   <li class="nav-item">
					    <a class="nav-link active" href="${pageContext.request.contextPath}/admin/admin_declaration_class_list_page.do">
					    	원데이클래스
					    </a>
					  </li>
						...
						<div class="col">
			                ...
			                <tbody>
								<c:forEach items="${resultList }" var="data">
									<tr>
										<th class="text-center">${data.classSingoVo.jet_board_class_singo_no }</th>
										<td><a href="${pageContext.request.contextPath }/classboard/detail_class_page.do?jet_class_detail_no=${data.classDetailVo.jet_class_detail_no}">
											${data.classVo.jet_class_name }
										</a></td>
										<td>${data.classSingoVo.jet_board_class_singo_reason }</td>
										<td>${data.singoMemberVo.jet_member_nick }</td>
										<td class="text-center"><fmt:formatDate pattern="yyyy-MM-dd" value="${data.classSingoVo.jet_board_class_singo_date }"/></td>
