			...
			<div class="row">	<%--탭 페이지  --%>
				<div class="col">
					<ul class="nav nav-tabs">
					  <li class="nav-item">
					    <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath }/admin/admin_declaration_notice_list_page.do">
					    	Notice
					    </a>
					  </li>
					  <li class="nav-item">
					  ...
					  <li class="nav-item">
					    <a class="nav-link" href="${pageContext.request.contextPath }/admin/admin_declaration_knowhow_list_page.do">
					    	팁과노하우
					    </a>
					  </li>
					  <li class="nav-item">
						...
						<div class="col">
			                ...
			                <tbody>
								<c:forEach items="${resultList }" var="data">
									<tr>
										<th class="text-center">${data.noticeSingoVo.jet_board_notice_singo_no }</th>
										<td><a href="${pageContext.request.contextPath }/notice_board/read_notice_board_page.do?jet_board_notice_no=${data.noticeBoardVo.jet_board_notice_no}">
											${data.noticeBoardVo.jet_board_notice_title }
										</a></td>
										<td>${data.noticeSingoVo.jet_board_notice_singo_reason }</td>
										<td>${data.singoMemberVo.jet_member_nick }</td>
										<td class="text-center"><fmt:formatDate pattern="yyyy-MM-dd" value="${data.noticeSingoVo.jet_board_notice_singo_date }"/></td>
