	...
	<div class="row">	
		...
		<div id="mainbox" class="col mx-3 my-3" style="background-color:#ffff"; > <%--관리자 메인 페이지 --%>
			...
			<div class="row">
				<div class="col"></div>
				<div class="col"></div>
				<div class="col-3 text-muted" style="text-align: right;">
					home > csBoard > unAnsweredAll
				</div>
			</div>
			...
			<div class="row">	<%--탭 페이지  --%>
				<div class="col">
					<ul class="nav nav-tabs">
					  ...
					  <li class="nav-item">
					    <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath }/admin/admin_csboard_before_page.do">
					    	미답변
					    </a>
					  </li>
					  <li class="nav-item">
					  ...
					  <li class="nav-item">
					    <a class="nav-link" href="${pageContext.request.contextPath }/admin/admin_assign_complete_page.do">
					    	Assign[답변 완료]
					    </a>
					  </li>
...
colBox.append(tableBox);

tableBox.append(theadBox);

theadBox.append(trmainBox);
trmainBox.append(thNoBox);
trmainBox.append(thcaBox);
trmainBox.append(thTitleBox);
trmainBox.append(thWriterBox);
trmainBox.append(thReadCountBox);
trmainBox.append(thDateBox);

tableBox.append(tbodyBox);

tbodyBox.append(TrBox);
