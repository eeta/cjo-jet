...
<jsp:include page="../shareplan_board/script/write_shareplan_board_page_script.jsp"/>
</head>
...
<jsp:include page="../commons/top_image.jsp"/>
	...
	<form id="share_form" action="${pageContext.request.contextPath}/shareplan_board/write_shareplan_board_process.do"  method="post" enctype="multipart/form-data">
            <div class="container">
                <div class="row mt-2">
                    <div class="col-5"></div>
                    <div class="col-4"></div>
                ...
                <div class="row justify-content-center">
	                ...
	                <div class="row justify-content-center">
	                    <div class="col-10">
	                        <div>
	                            <input id="share_title" name="jet_board_shareplan_title" type="text" class="form-control" placeholder="제목을 입력해라">
	                        </div>
	                    </div>
								...
								<div class="row">
									...
									<div class="col mx-auto my-auto alert alert-warning alert-dismissible fade show" role="alert">
										<div class="text-center">
											내가 작성한 <strong>여행 계획</strong>을 추가하세요!
										</div>
