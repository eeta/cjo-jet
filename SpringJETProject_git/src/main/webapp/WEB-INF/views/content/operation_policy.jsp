...
<div class="container-fluid">
		<div class="row">
			<div class="col-2"></div>
			<div class="col" style="border: 3px solid green;">
			1. 사용 전 꼭 숙지하여 주세요.
본 운영정책은 주식회사 주)제트(이하 ‘회사’)가 제공하는 주)제트계정 서비스 및 다양한 인터넷과 모바일 서비스를 운영함에 있어, 서비스 내에 발생할 수 있는 문제 상황에 대하여 일관성 있게 대처하기 위하여 서비스 운영의 기준과 여러분이 지켜주셔야 할 세부적인 사항이 규정되어 있습니다. 본 운영정책을 지키지 않을 경우 불이익을 당할 수 있으니 주의 깊게 읽어 주시기 바랍니다.

본 운영정책에서 별도로 정의하지 않은 용어는 주)제트 통합서비스약관에서 정한 용어의 정의에 따릅니다. 다만 본 운영정책에서 “개별 서비스”라 함은 kakao, Daum, Melon 등 브랜드 단위의 개별 서비스 내의 세부 하위 서비스까지 포괄하여 지칭함을 유의하여 주시기 바랍니다.
...
(5)악성코드, 바이러스 등의 프로그램을 설치·유포하여 서비스 이용을 저해하는 행위
(6)컴퓨터 소프트웨어, 하드웨어, 전기통신 장비의 정상적인 가동을 방해·파괴하거나, 할 수 있는 행위
(7)타인의 개인정보를 탈취·유포·거래하려는 행위
(8)방송·음원·영화·만화·사진·영상·게시물 등 타인의 저작물을 당사자의 동의 없이 공유하거나, 불법적인 경로로 획득할 수 있는 정보나 방법을 제공하는 행위
(9)타인의 권리에 속하는 상표권, 의장권 등을 무단으로 침해하는 행위
(10)청소년에게 유해한 과도한 신체 노출이나 음란한 행위를 묘사하는 행위
(11)성매매 관련 정보를 공유하는 행위
(12)타인에게 성적 수치심이나 불쾌감·혐오감을 유발할 수 있는 내용을 게시하는 행위
(13)타인의 성을 착취하는 내용을 담은 영상이나 이미지 등의 콘텐츠를 제공하거나, 이를 제공 또는 이용하려는 의사를 적극적으로 표현하는 행위
(14)타인의 성을 착취할 목적으로 협박, 유인하거나 이를 모의, 조장하는 행위
(15)출신(국가, 지역 등)・인종・외양・장애 및 질병 유무・사회 경제적 상황 및 지위・종교・연령・성별・성정체성・성적 지향 또는 기타 정체성 요인 등을 이유로 인간으로서의 존엄성을 훼손하거나, 폭력을 선동하거나, 차별・편견을 조장하는 행위
(16)자살·동반자살을 목적으로 하거나 방조 또는 유인하는 행위
(17)동일한 내용을 동일 개별 서비스 또는 여러 개별 서비스에 반복적으로 등록하는 행위
(18)타인의 명시적인 동의 없이 시스템의 취약점을 이용하여 타인의 게시글 또는 공간에 광고·홍보·방문 유도 등 상업적 내용을 등록·전송하거나 ‘공감’, ‘친구신청’ 등의 활동을 하는 행위
(19)서비스의 명칭 또는 회사의 임직원이나 운영진을 사칭하여 다른 이용자를 속이거나 이득을 취하는 등 피해와 혼란을 주는 행위
(20)욕설·비속어·은어 등의 사용 및 그 외 상식과 사회 통념에 반하는 비정상적인 행위
(21)언론사의 명의나 언론사의 직책 등을 사칭 또는 도용하여 기사 형태를 갖춘 게시물 중 그 내용이 허위로 판단되는 게시물을 게시하는 행위
(22)회사가 허용하지 않은 악의적인 방법으로 서비스를 이용하는 등 서비스의 정상적인 운영을 방해하는 행위
...
6. 서비스 휴면 정책 (장기 미접속 회원의 서비스 이용 안내)
정보통신망 이용촉진 및 정보보호 등에 관한 법률 시행령에 따라 아래 기간 동안 서비스를 이용하지 않으면 개인정보를 파기 또는 분리 보관 후 이용계약을 해지할 수 있습니다.

①주)제트계정 이용자
(1)1년 동안 주)제트계정을 i) 통합서비스 내의 어떠한 개별 서비스에서도 이용하지 않은 경우 또는 ii) 주)제트 통합서비스 약관에 동의하지 않은 이용자의 경우에는 kakao 브랜드를 사용하는 어떠한 서비스에서도 이용하지 않은 경우, 주)제트계정이 휴면 전환되어 주)제트계정의 개인정보를 분리 보관합니다.
(2)분리 보관 이후 4년 동안 로그인 하지 않을 경우, 주)제트계정의 개인정보를 파기하고 주)제트계정은 탈퇴 처리합니다.
(3)단, 주)제트톡은 주)제트계정이 휴면 전환되면 주)제트톡 서비스 내 개인정보를 파기한 후 주)제트톡 서비스의 이용계약을 해지합니다.
②주)제트계정에 가입하지 않은 주)제트톡 서비스 이용자
(1)주)제트톡 서비스를 1년 동안 이용하지 않을 경우, 주)제트톡 서비스 내 개인정보를 파기한 후 주)제트톡 서비스 이용계약을 해지합니다. 
