      ...
      */
      ...
      var tbContent = document.getElementById("jet_board_tp_detail_content");         
         */
         ...
         <%--var input_tbDetailNo = document.createElement("input");
         input_tbDetailNo.setAttribute("type","hidden");
         input_tbDetailNo.setAttribute("name","jet_board_tp_detail_no");
         input_tbDetailNo.setAttribute("value",tbDetailNo.value);
         deleteBox.appendChild(input_tbDetailNo);--%>
      ...
      var targetValue = parseInt(tbDay.value);
