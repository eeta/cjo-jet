			...
			<div class="row">	<%--탭 페이지  --%>
				<div class="col">
					<ul class="nav nav-tabs">
					  ...
					  <li class="nav-item">
					    <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath }/admin/admin_assign_before_page.do">
					    	Assign[미답변]
					    </a>
					  </li>
					  <li class="nav-item">
			...
			<div class="row mt-2"> <%--문의글 테이블 --%>
				<div class="col">
					...
					<div class="row">	 <%--검색 row--%>
						<div class="col-8"></div>
						<div class="col">
						<form action="${pageContext.request.contextPath }/admin/admin_assign_before_page.do" method="get">
							<div class="row">
								<div class="col-3">
					...
					<div class="row mt-2">
						<div class="col">
			                ...
			                <tbody> 	<%--여기서 문제점.. 1.배정받은 미답변 페이지에서 로그아웃시 널포인트.. 예외처리 해놧음 memberController에서..--%>
