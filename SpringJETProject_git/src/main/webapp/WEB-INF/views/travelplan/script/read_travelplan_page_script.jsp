...
<script type="text/javascript">
	...
	function shareToJetBoard(){
		//var updateStatus = document.getElementById("updateStatus");
		var jet_board_travelplan_no = ${result.travelplanVo.jet_board_travelplan_no};
		...
		xmlhttp.open("get","${pageContext.request.contextPath}/travelplan/update_sharestatus_process.do?jet_board_travelplan_no="+jet_board_travelplan_no);
		//xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xmlhttp.send();
		
		var frmShareToJet = document.getElementById("frm_share");
		frmShareToJet.submit();
	}
	
	function gatherPartyByPlan(){
		var jet_board_travelplan_no = ${result.travelplanVo.jet_board_travelplan_no};
		
		var frmGatherParty = document.getElementById("frm_gatherparty");
		frmGatherParty.submit();
	}
